...
public class SettingsActivity extends Activity {
    @Override protected void onCreate(Bundle state){
        ...
        LinearLayout updates=UiKit.card(this,root);updates.addView(UiKit.text(this,"App updates and backups",20,true));updates.addView(UiKit.text(this,"Manually check GitHub for a newer APK. A local backup is created before installation and existing app data is preserved.",13,false));Button updatesButton=UiKit.button(this,"Open app updates");updates.addView(updatesButton);updatesButton.setOnClickListener(v->startActivity(new Intent(this,AppUpdateActivity.class)));

        LinearLayout diagnostics=UiKit.card(this,root);diagnostics.addView(UiKit.text(this,"Navigation diagnostics",20,true));diagnostics.addView(UiKit.text(this,"View live GPS injection status and save a ZIP after a failed trip.",13,false));Button diagnosticsButton=UiKit.secondaryButton(this,"Open navigation diagnostics");diagnostics.addView(diagnosticsButton);diagnosticsButton.setOnClickListener(v->startActivity(new Intent(this,DiagnosticsActivity.class)));
