...
public class CampaignActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle b){
        ...
        form.addView(UiKit.text(this,"Campaign details",18,true));
        ...
        Button save=UiKit.secondaryButton(this,"Save campaign");form.addView(save);save.setOnClickListener(v->{try{JSONObject c=build(random.isChecked(),hold.isChecked());CampaignStore.save(this,c);status.setText("Campaign saved");refresh();}catch(Exception e){toast(e.getMessage());}});
