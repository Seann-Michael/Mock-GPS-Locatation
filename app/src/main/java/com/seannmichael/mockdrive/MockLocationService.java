...
public class MockLocationService extends Service {
    ...
    private Notification notice(String text){
        PendingIntent pi=PendingIntent.getActivity(this,0,new Intent(this,SimpleDriveActivity.class),PendingIntent.FLAG_UPDATE_CURRENT|PendingIntent.FLAG_IMMUTABLE);
